...
\begin{proof}
    ...
    because there can always be an element $x$ in the set $\mathcal{U} / A_1 \cup A_2 \cup A_{k+1} $ no matter what new set $A_{k+1}$ you choose. If $x$ is in this set, then for the reasons stated in the base case $x$ is also in $A_1^c \cap A_2^c \cap A_{k+1}^c.$ The converse is true for the same reasoning in the base case.
\end{proof}
...
\begin{proof}
    ...
    because there can always be an element $x$ in the set $\mathcal{U} / A_1 \cap A_2 \cap A_{k+1} $ no matter what new set $A_{k+1}$ you choose. If $x$ is in this set, then for the reasons stated in the base case $x$ is also in $A_1^c \cup A_2^c \cup A_{k+1}^c.$ The converse is true for the same reasoning in the base case.
\end{proof}
